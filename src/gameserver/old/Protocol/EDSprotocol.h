...
void GDGuildCreateSend(CGameObject* lpObj, LPSTR Name, LPSTR Master, LPBYTE Mark, int iGuildType);
void GDGuildCreateRecv( SDHP_GUILDCREATE_RESULT* lpMsg);
void GDGuildDestroySend(CGameObject* lpObj, LPSTR Name, LPSTR Master);
void GDGuildDestroyRecv( SDHP_GUILDDESTROY_RESULT* lpMsg);
void GDGuildMemberAdd(CGameObject* lpObj, LPSTR Name, LPSTR MemberId);
...
void GDGuildMemberDel(CGameObject* lpObj, LPSTR Name, LPSTR MemberId);
...
void DGGuildMemberInfoRequest(CGameObject* lpObj);
...
void GDGuildReqAssignStatus(CGameObject* lpObj, int iAssignType, LPSTR szTagetName, int iGuildStatus);
void DGGuildAnsAssignStatus( EXSDHP_GUILD_ASSIGN_STATUS_RESULT* lpMsg);
void GDGuildReqAssignType(CGameObject* lpObj, int iGuildType);
void DGGuildAnsAssignType( EXSDHP_GUILD_ASSIGN_TYPE_RESULT* lpMsg);
void GDRelationShipReqJoin(CGameObject* lpObj, int iTargetUserIndex, int iRelationShipType);
void DGRelationShipAnsJoin( EXSDHP_RELATIONSHIP_JOIN_RESULT* lpMsg);
void GDUnionBreakOff(CGameObject* lpObj, int iUnionNumber);
void DGUnionBreakOff( EXSDHP_RELATIONSHIP_BREAKOFF_RESULT* lpMsg);
void GDRelationShipReqBreakOff(CGameObject* lpObj, int iTargetUserIndex, int iRelationShipType);
...
void GDRelationShipReqKickOutUnionMember(CGameObject* lpObj, LPSTR szTargetGuildName);
void DGRelationShipAnsKickOutUnionMember( EXSDHP_KICKOUT_UNIONMEMBER_RESULT* lpMsg);
void FriendListRequest(CGameObject* lpObj);
void FriendListResult(LPBYTE lpMsg);
void WaitFriendListResult( FHP_WAITFRIENDLIST_COUNT* lpMsg);
void FriendStateClientRecv( PMSG_FRIEND_STATE_C* lpMsg, CGameObject* lpObj);
void FriendStateRecv( FHP_FRIEND_STATE* lpMsg);
void FriendAddRequest( PMSG_FRIEND_ADD_REQ * lpMsg, CGameObject* lpObj);
void FriendAddResult( FHP_FRIEND_ADD_RESULT* lpMsg);
void WaitFriendAddRequest( PMSG_FRIEND_ADD_SIN_RESULT* lpMsg, CGameObject* lpObj);
void WaitFriendAddResult( FHP_WAITFRIEND_ADD_RESULT* lpMsg);
void FriendDelRequest( PMSG_FRIEND_DEL_REQ* lpMsg, CGameObject* lpObj);
void FriendDelResult( FHP_FRIEND_DEL_RESULT* lpMsg);
void FriendChatRoomCreateReq( PMSG_FRIEND_ROOMCREATE_REQ* lpMsg, CGameObject* lpObj);
void FriendChatRoomCreateResult( FHP_FRIEND_CHATROOM_CREATE_RESULT* lpMsg);
void FriendMemoSend( PMSG_FRIEND_MEMO* lpMsg, CGameObject* lpObj);
...
void FriendMemoListReq(CGameObject* lpObj);
void FriendMemoList( FHP_FRIEND_MEMO_LIST* lpMsg);
void FriendMemoReadReq( PMSG_FRIEND_READ_MEMO_REQ* lpMsg, CGameObject* lpObj);
void FriendMemoRead( FHP_FRIEND_MEMO_RECV* lpMsg);
void FriendMemoDelReq( PMSG_FRIEND_MEMO_DEL_REQ* lpMsg, CGameObject* lpObj);
void FriendMemoDelResult( FHP_FRIEND_MEMO_DEL_RESULT* lpMsg);
void FriendRoomInvitationReq( PMSG_ROOM_INVITATION* lpMsg, CGameObject* lpObj);
...
// Guild Matching
void GDReqGuildMatchingList(CGameObject* lpObj, int nPage);
void GDReqGuildMatchingListSearchWord(CGameObject* lpObj, int nPage, char *szSearchWord);
void DGAnsGuildMatchingList(_stAnsGuildMatchingList *lpMsg);
void GDReqDelMatchingList(CGameObject* lpObj, int nGuildNum);
void DGAnsDelMatchingList(_stAnsDelGuildMatchingList *lpMsg);
void GDReqRegGuildMatchingList(CGameObject* lpObj, _stGuildMatchingList stGuildMatchingList);
void DGAnsRegGuildMatchingList(_stAnsGuildMatchingData *lpMsg);
void GDReqJoinGuildMatchingList(CGameObject* lpObj, _stGuildMatchingAllowListDB stAllowList);
void DGAnsJoinGuildMatching(_stAnsWaitGuildMatching *lpMsg);
void GDReqCancelJoinGuildMatching(CGameObject* lpObj, char *szName, int nType);
void DGAnsCancelJoinGuildMatching(_stAnsDelWaitGuildMatchingList *lpMsg);
void GDReqAllowJoinGuildMatching(CGameObject* lpObj, int nAllowType, char *szName, char *szGuildName);
void DGAnsAllowJoinGuildMatching(_stAnsAllowJoinGuildMatching *lpMsg);
void GDReqWaitGuildMatchingList(int nGuildNumber, CGameObject* lpObj);
void DGAnsWaitGuildMatchingList(_stAnsWaitGuildMatchingList *lpMsg);
void GDReqGetWaitStateListGuildMatching(CGameObject* lpObj, char* szApplicantName);
...
// Party Matching
void GDReqRegWantedPartyMember(_PARTY_INFO_LISTDB stList, CGameObject* lpObj);
void DGAnsRegWantedPartyMember(_stAnsRegWantedPartyMember *lpMsg);
void GDReqGetPartyMatchingList(int nPage, char *szSearchWord, int nType, CGameObject* lpObj);
void DGAnsGetPartyMatchingList(_stAnsGetPartyMatchingList *lpMsg);
void GDReqJoinMemberPartyMatching(char *szMemberName, char *szLeaderName, char *szPassWord, CGameObject* lpObj, int nUserDBNumber, int nLevel, BYTE btClass, BYTE btRandomParty, BYTE btGensType, BYTE btChangeUpClass);
void DGAnsJoinMemberPartyMatching(_stAnsJoinMemberPartyMatching *lpMsg);
void GDReqMemberJoinStateList(char *szMemberName, CGameObject* lpObj);
void DGAnsMemberJoinStateList(_stAnsJoinMemberStateListPartyMatching *lpMsg);
void GDReqMemberJoinStateListLeader(char *szLeaderName, CGameObject* lpObj);
...
void GDReqCancelPartyMatching(CGameObject* lpObj, BYTE btType);
void DGAnsCancelPartyMatching(_stAnsCancelPartyMatching *lpMsg);
void GDReqAcceptMemberJoin(CGameObject* lpObj, BYTE btType, char *szLeaderName, char *szMemberName, BYTE btManual);
void DGAnsAcceptMemberJoin(_stAnsAddPartyMember *lpMsg);
void DGFixAddPartyMember(_stAnsAddRealPartyMember *lpMsg);
void GDReqDeletePartyUser(CGameObject* lpObj, char *szTargetName);
