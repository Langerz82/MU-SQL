...
void CEledoradoEvent::RegenTitan()
{
	...
	for (int i = 0; i < It->second.m_Count; i++)
	{
		...
		this->m_BossTitanMapNumber = getGameObject(result)->MapNumber;
		this->m_BossTitanMapX = getGameObject(result)->X;
...
void CEledoradoEvent::RegenGoldDercon()
{
	...
	for (int i = 0; i < It->second.m_Count; i++)
	{
		...
		getGameObject(result)->m_BossGoldDerconMapNumber = MapNumber;	// #error change count by MapNumber
		count++;
	}
...
void CEledoradoEvent::RegenDevilLizardKing()
{
	...
	for (int i = 0; i < It->second.m_Count; i++)
	{
		...
		this->m_BossDevilLizardKingMapNumber = getGameObject(result)->MapNumber;
		this->m_BossDevilLizardKingMapX = getGameObject(result)->X;
...
void CEledoradoEvent::RegenKantur()
{
	...
	for (int i = 0; i < It->second.m_Count; i++)
	{
		...
		this->m_BossKanturMapNumber = getGameObject(result)->MapNumber;
		this->m_BossKanturMapX = getGameObject(result)->X;
