...
public:
	...
	int CheckChoasMixItem(CGameObject &Obj);
	bool BloodCastleChaosMix(CGameObject &Obj, int iLEVEL);
	bool AddExperience(CGameObject &Obj, int iEXP);
	int CalcSendRewardEXP(CGameObject &Obj, int iEXP);
	int CalcSendRewardZEN(CGameObject &Obj, int iZEN);
	void DropReward(CGameObject &Obj);
	void SendRewardScore(CGameObject &Obj, int iSCORE, int iLeftTime, int iAlivePartyCount);
	void GiveReward_Win(CGameObject &Obj, int iBridgeIndex);
	...
	bool CheckEnterFreeTicket(CGameObject &Obj);
	int CheckEnterItem(CGameObject &Obj);
	int CheckQuestItem(CGameObject &Obj);
	bool CheckWalk(CGameObject &Obj, int iMoveX, int iMoveY);
