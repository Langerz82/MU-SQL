...
void CRaklionUtil::NotifyLeftTopMsgRaklionBattleUser(char *lpszMsg, ...)
{
	...
	{
		if( getGameObject(g_RaklionBattleUserMng.m_BattleUser[iCount])->Connected == PLAYER_PLAYING &&
			getGameObject(g_RaklionBattleUserMng.m_BattleUser[iCount])->Type == OBJ_USER)
		{
