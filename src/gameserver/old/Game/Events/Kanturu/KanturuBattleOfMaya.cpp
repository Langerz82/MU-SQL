...
void CKanturuBattleOfMaya::ProcState_MAYA1()
{
	...
	if ( getGameObject(this->m_iMayaLeftHandObjIndex)->Live == FALSE )
	{
...
void CKanturuBattleOfMaya::ProcState_MAYA2()
{
	...
	if ( getGameObject(this->m_iMayaRightHandObjIndex)->Live == FALSE )
	{
		if ( this->m_iMayaHandDieTimeCounter == 0 )
		{
			this->SetSuccessValue(TRUE);
...
void CKanturuBattleOfMaya::ResetAIMonster()
{
	...
	{
		getGameObject(this->m_iMayaLeftHandObjIndex)->Life = 0;
		getGameObject(this->m_iMayaRightHandObjIndex)->Life = 0;
	}
