...
public:
	...
	int CheckMainToMove(CGameObject &Obj);
	int CheckEquipmentToMove(CGameObject &Obj, int iTargetMapNumber);
	int CheckInterfaceToMove(CGameObject &Obj);
	int Move(CGameObject &Obj, int iMapIndex);
	int Move(CGameObject &Obj, char* mapname);
	int MoveFree2Kalima(CGameObject &Obj);
