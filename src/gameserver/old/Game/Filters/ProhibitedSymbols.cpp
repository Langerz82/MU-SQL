...
void CProhibitedSymbols::LoadSymbolFile(LPSTR szFile)
{
	...
	this->m_nMode = mainXML_section.attribute("Mode").as_int();
	pugi::xml_node symbol_section = mainXML_section.child("Symbols");
	...
	pugi::xml_node regex_section = mainXML_section.child("Regex");
