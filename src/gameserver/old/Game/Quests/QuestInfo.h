...
public:
	...
	LPQUEST_SUB_INFO GetSubquestInfo(CGameObject &Obj, LPQUEST_INFO lpQuestInfo, int subquestindex);
	LPQUEST_CONDITION GetQuestCondition(LPQUEST_INFO lpQuestInfo, int conditionindex);
	int GetQuestState(CGameObject &Obj, int QuestIndex);
	BYTE GetQuestStateBYTE(CGameObject &Obj, int QuestIndex);
	BYTE SetQuestState(CGameObject &Obj, int QuestIndex, int State);
	BYTE ReSetQuestState(CGameObject &Obj, int QuestIndex);
	BYTE QuestClearConditionCheck(CGameObject &Obj, int QuestIndex);
	BYTE QuestRunConditionCheck(CGameObject &Obj, int QuestIndex);
	int CompareCondition(CGameObject &Obj, LPQUEST_CONDITION lpCondition);
	int NpcTalk(CGameObject &Npc, CGameObject lpObj);
	int MonsterItemDrop(CGameObject &Obj);
	int MonsterItemDropParty(CGameObject &Obj, CGameObject lpMonsterObj);
	int AddMonsterKillCount(CGameObject &Obj);
	int QuestAccept(CGameObject &Obj, int QuestIndex);
	int QuestClear(CGameObject &Obj, int QuestIndex);
	void QuestInfoSave(CGameObject &Obj);
	int GetQuestKillCount(CGameObject &Obj, int uClass);
	int GetQuestItem(CGameObject &Obj, short nType, short nLevel);
	void SendQuestMonsterKill(CGameObject &Obj, int iQuestIndex);
