...
public:
	...
	int ForceAIElement(CGameObject &Obj, int iTargetIndex,  TMonsterAIState* pAIState);
	int ApplyElementCommon(CGameObject &Obj, int iTargetIndex,  TMonsterAIState* pAIState);
	int ApplyElementMove(CGameObject &Obj, int iTargetIndex,  TMonsterAIState* pAIState);
	int ApplyElementMoveTarget(CGameObject &Obj, int iTargetIndex,  TMonsterAIState* pAIState);
	int ApplyElementGroupMove(CGameObject &Obj, int iTargetIndex,  TMonsterAIState* pAIState);
	int ApplyElementAttack(CGameObject &Obj, int iTargetIndex,  TMonsterAIState* pAIState);
	int ApplyElementAttackArea(CGameObject &Obj, int iTargetIndex,  TMonsterAIState* pAIState);
	int ApplyElementAttackPenetration(CGameObject &Obj, int iTargetIndex,  TMonsterAIState* pAIState);
	int ApplyElementAvoid(CGameObject &Obj, int iTargetIndex,  TMonsterAIState* pAIState);
	int ApplyElementHealSelf(CGameObject &Obj, int iTargetIndex,  TMonsterAIState* pAIState);
	int ApplyElementHealGroup(CGameObject &Obj, int iTargetIndex,  TMonsterAIState* pAIState);
	int ApplyElementSpecialSommon(CGameObject &Obj, int iTargetIndex,  TMonsterAIState* pAIState);
	int ApplyElementSpecialImmune(CGameObject &Obj, int iTargetIndex,  TMonsterAIState* pAIState);
	int ApplyElementNightmareSummon(CGameObject &Obj, int iTargetIndex,  TMonsterAIState* pAIState);
	int ApplyElementNightmareWarp(CGameObject &Obj, int iTargetIndex,  TMonsterAIState* pAIState);
	int ApplyElementSkillAttack(CGameObject &Obj, int iTargetIndex,  TMonsterAIState* pAIState);
	int ApplyElementAIChange(CGameObject &Obj, int iTargetIndex,  TMonsterAIState* pAIState);
	void Reset();
