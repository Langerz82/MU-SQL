...
public:
	...
	void Run();
	bool MonsterKillCheck(CGameObject &Player, CGameObject lpMonster);
private:
	void RegenMonster(int nGroupNumber);
	bool SetPosMonster(CGameObject &Obj, int nMapNumber, int nBeginX, int nBeginY, int nEndX, int nEndY);
