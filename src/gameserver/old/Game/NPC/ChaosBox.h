...
public:
	...
	void GCChaosMixSend(CGameObject &Obj, BYTE result, CItemObject* lpItem);
	BOOL ChaosBoxCheck(CGameObject &Obj);
	BOOL ChaosBoxInit(CGameObject &Obj);
	BOOL ChaosBoxItemDown(CGameObject &Obj);
	int ChaosBoxMix(CGameObject &Obj, int & Result2, int & WingNum);
	int  CheckDevilSquareItem(CGameObject &Obj, int & eventitemcount, int & itemlevel);
	void LogDQChaosItem(CGameObject &Obj);
	BOOL DevilSquareEventChaosMix(CGameObject &Obj, BOOL bCheckType, int iItemLevel);
	void LogChaosItem(CGameObject &Obj, LPSTR sLogType);
	BOOL PlusItemLevelChaosMix(CGameObject &Obj, int mixType);
	void PlusItemLevelMixTest(CGameObject &Obj, int type);
	void ChaosMixCharmItemUsed(CGameObject &Obj);
	BOOL IsDeleteItem(int iItemCode);
	BOOL PegasiaChaosMix(CGameObject &Obj);
	BOOL CircleChaosMix(CGameObject &Obj);
	BOOL WingChaosMix(CGameObject &Obj);
	BOOL IllusionTempleItemChaosMix(CGameObject &Obj);
	...
	BOOL FeatherOfCondorMix(CGameObject &Obj);
	BOOL ThirdWingLevel2ChaosMix(CGameObject &Obj);
	void ThirdWingMixFail(CGameObject &Obj);
	void ThirdWingMixFailItemPanalty(CItemObject * lpItem);
	void DefaultChaosMix(CGameObject &Obj);
	void DevilSquareItemChaosMix(CGameObject &Obj);
	void BloodCastleItemChaosMix(CGameObject &Obj);
	void SetItemChaosMix(CGameObject &Obj);
	void DarkHorseChaosMix(CGameObject &Obj);
	void DarkSpiritChaosMix(CGameObject &Obj);
	void BlessPotionChaosMix(CGameObject &Obj);
	void SoulPotionChaosMix(CGameObject &Obj);
	void LifeStoneChaosMix(CGameObject &Obj);
	void CastleSpecialItemMix(CGameObject &Obj);
	void HiddenTreasureBoxItemMix(CGameObject &Obj);
	void Fenrir_01Level_Mix(CGameObject &Obj);
	void Fenrir_02Level_Mix(CGameObject &Obj);
	void Fenrir_03Level_Mix(CGameObject &Obj);
	void Fenrir_04Upgrade_Mix(CGameObject &Obj);
	void ShieldPotionLv1_Mix(CGameObject &Obj);
	void ShieldPotionLv2_Mix(CGameObject &Obj);
	void ShieldPotionLv3_Mix(CGameObject &Obj);
	void LotteryItemMix(CGameObject &Obj, int type);
	BOOL SocketItemUpgradeMixS12(CGameObject &Obj, BYTE ItemPos, BYTE SocketUpgradeNotePos, BYTE JoBlessPos1, BYTE JoBlessPos2, BYTE JoBlessPos3, BYTE JoBlessPos4, BYTE JoBlessPos5, BYTE JoSoulPos1, BYTE JoSoulPos2, BYTE JoSoulPos3, BYTE JoSoulPos4, BYTE JoSoulPos5, BYTE JoChaosPos);
	void SeedExtractMix(CGameObject &Obj);
	BOOL SeedExtractMixS12(CGameObject &Obj, BYTE AncientPos, BYTE ExePos, BYTE JOHPos, BYTE JOCPos, BYTE ChaosPos);
	void SeedSphereCompositeMix(CGameObject &Obj);
	void SeedSphereCompositeMixS12(CGameObject &Obj, BYTE SeedPos, BYTE SpherePos, BYTE JocPos, BYTE ChaosPos);
	BOOL SeedSphereEnhance(CGameObject &Obj, BYTE Sphere1, BYTE Sphere2, BYTE Rune);
	void SetSeedSphereMix(CGameObject &Obj, BYTE btPos);
	void SetSeedSphereMixS12(CGameObject &Obj, BYTE ItemPos, BYTE Slot, BYTE SeedPos, BYTE JocPos, BYTE ChaosPos);
	void SeedSphereRemoveMix(CGameObject &Obj, BYTE btPos);
	void SeedSphereRemoveMixS12(CGameObject &Obj, BYTE ItemPos, BYTE Slot, BYTE JogPos, BYTE JohPos1, BYTE JohPos2, BYTE JohPos3, BYTE JohPos4, BYTE JohPos5, BYTE ChaosPos1, BYTE ChaosPos2, BYTE ChaosPos3, BYTE ChaosPos4, BYTE ChaosPos5);
	void SecromiconMix(CGameObject &Obj);
	void PremiumBoxMix(CGameObject &Obj);
	void CherryBlossomMix(CGameObject &Obj);
	void ItemRefineMix(CGameObject &Obj);
	void MonsterWingMix(CGameObject &Obj);
	void SummonsMix(CGameObject &Obj, int type);
	void CCFRewardMix(CGameObject &Obj);
	void DSFRewardMix(CGameObject &Obj);
	void AncientSoulItemMix(CGameObject &Obj);
	void BloodAngelUnSealMix(CGameObject &Obj, int iMixType);
	void BloodAngelUnSealMix2(CGameObject &Obj, int iMixType);
	void DarkAngelMix(CGameObject &Obj, int iMixType);
	void DarkAngelNextMix(CGameObject &Obj, int iMixType);
	void DarkAngelWeaponMix(CGameObject &Obj, int iMixType);
	void ArchangelHammerMix(CGameObject &Obj);
	void BlessedAAMix(CGameObject &Obj);
	BOOL AdvancedWingMix(CGameObject &Obj);
	void BloodCastleMix(CGameObject &Obj);
	BOOL CheckHeroSoulItem(int iItemCode);
	bool GetElementalTalismanOfLuckRate(CGameObject &Obj, int* rate);
	bool GetTalismanOfLuckRate(CGameObject &Obj, int* rate);
	// bloodangel mix
	BOOL bloodangelmix78(CGameObject &Obj);
	BOOL bloodangelmix79(CGameObject &Obj);
	BOOL bloodangelmix80(CGameObject &Obj);
	BOOL bloodangelmix81(CGameObject &Obj);

	BOOL bloodangelmix86(CGameObject &Obj);
	BOOL bloodangelmix87(CGameObject &Obj);
	BOOL bloodangelmix88(CGameObject &Obj);
	BOOL bloodangelmix89(CGameObject &Obj);

	BOOL bloodangelmix90(CGameObject &Obj);
	BOOL bloodangelmix91(CGameObject &Obj);
	BOOL bloodangelmix92(CGameObject &Obj);
	BOOL bloodangelmix93(CGameObject &Obj);

	BOOL bloodangelmix98(CGameObject &Obj);
	BOOL bloodangelmix99(CGameObject &Obj);
	BOOL bloodangelmix100(CGameObject &Obj);
	BOOL bloodangelmix101(CGameObject &Obj);

	BOOL bloodangelmix106(CGameObject &Obj);
	BOOL bloodangelmix107(CGameObject &Obj);
	BOOL bloodangelmix108(CGameObject &Obj);
	BOOL bloodangelmix109(CGameObject &Obj);

	BOOL bloodangelmix114(CGameObject &Obj);
	BOOL bloodangelmix115(CGameObject &Obj);
	BOOL bloodangelmix116(CGameObject &Obj);
	BOOL bloodangelmix117(CGameObject &Obj);

	BOOL bloodangelmix118(CGameObject &Obj);
	BOOL bloodangelmix119(CGameObject &Obj);
	BOOL bloodangelmix120(CGameObject &Obj);
	BOOL bloodangelmix121(CGameObject &Obj);

	BOOL bloodangelmix126(CGameObject &Obj);
	BOOL bloodangelmix127(CGameObject &Obj);
	BOOL bloodangelmix128(CGameObject &Obj);
	BOOL bloodangelmix129(CGameObject &Obj);

	void CheckEmptySpace_MultiMix(PMSG_REQ_CHAOS_MULTIMIX_CHECK * aRecv, CGameObject &Obj);

	void BlessPotionChaosMix_Multi(CGameObject &Obj, int iMixCount);
	void SoulPotionChaosMix_Multi(CGameObject &Obj, int iMixCount);
	void CircleChaosMix_Multi(CGameObject &Obj, int iMixCount);
	void PegasiaChaosMix_Multi(CGameObject &Obj, int iMixCount);
	void BloodCastleItemChaosMix_Multi(CGameObject &Obj, int iMixCount);
	void DevilSquareItemChaosMix_Multi(CGameObject &Obj, int iMixCount);
	void ShieldPotionLv1_Mix_Multi(CGameObject &Obj, int iMixCount);
	void ShieldPotionLv2_Mix_Multi(CGameObject &Obj, int iMixCount);
	void ShieldPotionLv3_Mix_Multi(CGameObject &Obj, int iMixCount);
	void PremiumBoxMix_Multi(CGameObject &Obj, int iMixCount);
	void JewelOfHarmonyItemPurityMix(CGameObject &Obj);
	void PurityJewelOfHarmony_MultiMix(CGameObject &Obj, int iMixCount);
private:
