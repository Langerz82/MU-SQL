 ...
 *
 */
class SqlResultQueue : public ACE_Based::LockedQueue<MuMySQLServer::IQueryCallback* , ACE_Thread_Mutex>
{
    public:
        /**
         * @brief
...
class SqlQuery : public SqlOperation
{
    private:
        const char* m_sql; /**< TODO */
        MuMySQLServer::IQueryCallback* m_callback; /**< TODO */
    ...
    public:
         ...
         * @param queue
         */
        SqlQuery(const char* sql, MuMySQLServer::IQueryCallback* callback, SqlResultQueue* queue)
...
class SqlQueryHolder
{
    ...
    public:
         ...
         * @return bool
         */
        bool Execute(MuMySQLServer::IQueryCallback* callback, SqlDelayThread* thread, SqlResultQueue* queue);
};
...
class SqlQueryHolderEx : public SqlOperation
{
    ...
    public:
         ...
         * @param queue
         */
        SqlQueryHolderEx(SqlQueryHolder* holder, MuMySQLServer::IQueryCallback* callback, SqlResultQueue* queue)
