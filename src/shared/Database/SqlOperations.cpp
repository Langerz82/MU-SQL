...
void SqlResultQueue::Update()
{
    ...
    MuMySQLServer::IQueryCallback* callback = NULL;
    while (next(callback))
    {
        callback->Execute();
        delete callback;
...
bool SqlQueryHolder::Execute(MuMySQLServer::IQueryCallback* callback, SqlDelayThread* thread, SqlResultQueue* queue)
{
