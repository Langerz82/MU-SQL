 ...
 *
 */
class Log : public MuMySQLServer::Singleton<Log, MuMySQLServer::ClassLevelLockable<Log, ACE_Thread_Mutex> >
{
        friend class MuMySQLServer::OperatorNew<Log>;
        /**
         * @brief
         *
         */
...
#define sLog MuMySQLServer::Singleton<Log>::Instance()
