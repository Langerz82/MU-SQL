...
public:
	...
	void SkillKnightRush(int aIndex, int aTargetIndex, CMagicInf* lpMagic);
	...
	int SkillBerserker(int aIndex, CMagicInf * lpMagic, int aTargetIndex);
	...
	int SkillFireBeast(int aIndex, int aTargetIndex, CMagicInf *lpMagic);
	int SkillIceBeast(int aIndex, int aTargetIndex, CMagicInf *lpMagic);
	int SkillMeteorStorm (int aIndex, CMagicInf* lpMagic, BYTE x, BYTE y, int aTargetIndex);
	...
	int SkillArchangelWillBuff(int aIndex, CMagicInf * lpMagic);
