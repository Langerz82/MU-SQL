...
void CDevilSquareGround::SendScore()
{
	...
	for ( ; Itor != this->m_DevilSquareRankList.end(); Itor++ )
	{
		...
		if (count == 1)
		{
			g_BagManager.UseBag_GremoryCase((*(Itor))->m_Index, BAG_EVENT, EVENTBAG_DS1, (*(Itor))->m_Index, GC_STORAGE_CHARACTER, GC_REWARD_DEVIL_SQUARE, 30);
		}
		else if (count == 2)
		{
			g_BagManager.UseBag_GremoryCase((*(Itor))->m_Index, BAG_EVENT, EVENTBAG_DS2, (*(Itor))->m_Index, GC_STORAGE_CHARACTER, GC_REWARD_DEVIL_SQUARE, 30);
		}
		else if (count == 3)
		{
			g_BagManager.UseBag_GremoryCase((*(Itor))->m_Index, BAG_EVENT, EVENTBAG_DS3, (*(Itor))->m_Index, GC_STORAGE_CHARACTER, GC_REWARD_DEVIL_SQUARE, 30);
		}
		else if (count == 4)
		{
			g_BagManager.UseBag_GremoryCase((*(Itor))->m_Index, BAG_EVENT, EVENTBAG_DS4, (*(Itor))->m_Index, GC_STORAGE_CHARACTER, GC_REWARD_DEVIL_SQUARE, 30);
		}
		else if (count == 5)
		{
			g_BagManager.UseBag_GremoryCase((*(Itor))->m_Index, BAG_EVENT, EVENTBAG_DS5, (*(Itor))->m_Index, GC_STORAGE_CHARACTER, GC_REWARD_DEVIL_SQUARE, 30);
		}
		else if (count == 6)
		{
			g_BagManager.UseBag_GremoryCase((*(Itor))->m_Index, BAG_EVENT, EVENTBAG_DS6, (*(Itor))->m_Index, GC_STORAGE_CHARACTER, GC_REWARD_DEVIL_SQUARE, 30);
		}
		else if (count == 7)
		{
			g_BagManager.UseBag_GremoryCase((*(Itor))->m_Index, BAG_EVENT, EVENTBAG_DS7, (*(Itor))->m_Index, GC_STORAGE_CHARACTER, GC_REWARD_DEVIL_SQUARE, 30);
		}
...
void CDevilSquareGround::DropReward(int iIndex)
{
	...
	case 0:
		...
		break;
	case 1:
		g_BagManager.UseBag_GremoryCase(iIndex, BAG_EVENT, EVENTBAG_DS2, iIndex, GC_STORAGE_CHARACTER, GC_REWARD_DEVIL_SQUARE, 30);
		break;
	case 2:
		g_BagManager.UseBag_GremoryCase(iIndex, BAG_EVENT, EVENTBAG_DS3, iIndex, GC_STORAGE_CHARACTER, GC_REWARD_DEVIL_SQUARE, 30);
		break;
	case 3:
		g_BagManager.UseBag_GremoryCase(iIndex, BAG_EVENT, EVENTBAG_DS4, iIndex, GC_STORAGE_CHARACTER, GC_REWARD_DEVIL_SQUARE, 30);
		break;
	case 4:
		g_BagManager.UseBag_GremoryCase(iIndex, BAG_EVENT, EVENTBAG_DS5, iIndex, GC_STORAGE_CHARACTER, GC_REWARD_DEVIL_SQUARE, 30);
		break;
	case 5:
		g_BagManager.UseBag_GremoryCase(iIndex, BAG_EVENT, EVENTBAG_DS6, iIndex, GC_STORAGE_CHARACTER, GC_REWARD_DEVIL_SQUARE, 30);
		break;
	case 6:
		g_BagManager.UseBag_GremoryCase(iIndex, BAG_EVENT, EVENTBAG_DS7, iIndex, GC_STORAGE_CHARACTER, GC_REWARD_DEVIL_SQUARE, 30);
		break;
