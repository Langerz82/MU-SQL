...
bool CSeedSphereItem::SetOption(CSeedItem *SeedItem, BYTE SphereLevel)
{
	...
	{
		case SEED_TYPE_FIRE:		
			m_ItemCode = ITEMGET(12,100);	
			break;
		case SEED_TYPE_WATER:		
			m_ItemCode = ITEMGET(12,101);	
			break;
		case SEED_TYPE_ICE:			
			m_ItemCode = ITEMGET(12,102);	
			break;
		case SEED_TYPE_WIND:		
			m_ItemCode = ITEMGET(12,103);	
			break;
		case SEED_TYPE_LIGHTNING:	
			m_ItemCode = ITEMGET(12,104);	
			break;
		case SEED_TYPE_EARTH:		
			m_ItemCode = ITEMGET(12,105);	
			break;
	...
	if ((m_ItemCode >= 124) && (m_ItemCode <= 129))
	{
		m_SeedType = SeedItem->m_SeedType + 187;
	}
