...
typedef void (*pFixPacket)(unsigned char* lpBody, int iSize);
...
public:
	...
	void PacketFix(LPBYTE lpMsg,BYTE Headcode,int iSize);
...
protected:
	...
	pFixPacket m_ProtocolFix[0xFF];

	static void FixPacket_F1(unsigned char* lpBody,int iSize);
	static void FixPacket_0E(unsigned char* lpBody,int iSize);
	static void FixPacket_03(unsigned char* lpBody,int iSize);
	static void FixPacket_F3(unsigned char* lpBody,int iSize);
