...
enum eSkillType
{
	...
	AT_SKILL_FIRE_BLOW = 723,
	AT_SKILL_METEOR_STRIKESM = 724,
	AT_SKILL_METEOR_STORM = 725,
	AT_SKILL_SOUL_SAKER = 726,
	AT_SKILL_FOCUS_SHOT = 727,
	AT_SKILL_FIRE_BIRD = 729,
	AT_SKILL_AQUA_BIST = 730,
	AT_SKILL_ICE_BLOOD = 731,
	AT_SKILL_FIRE_BLOOD = 732,
	AT_SKILL_DARKBLAST = 733,
	AT_SKILL_METEOR_STRIKEMG = 734,
	AT_SKILL_WINDSOUL = 737,
	AT_SKILL_DARK_PHOENIX_SHOT = 739,
	AT_SKILL_ARCHANGEL_WILL = 740
};
