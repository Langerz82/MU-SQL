...
int GetSkillNumberInex(int type, int Index, int level)
{
	...
	else if ( type == 12 )
	{
		...
		case 289:	skillnumber = 723;	break;
		case 290:	skillnumber = 724;	break;
		case 291:	skillnumber = 725;	break;
		case 292:	skillnumber = 726;	break;
		case 293:	skillnumber = 727;	break;
		case 295:	skillnumber = 729;	break;
		case 296:	skillnumber = 730;	break;
		case 297:	skillnumber = 731;	break;
		case 298:	skillnumber = 732;	break;
		case 299:	skillnumber = 733;	break;
		case 300:	skillnumber = AT_SKILL_METEOR_STRIKEMG;	break;
		case 303:	skillnumber = AT_SKILL_WINDSOUL;	break;
		case 305:	skillnumber = AT_SKILL_DARK_PHOENIX_SHOT;	break;
		}
	}
