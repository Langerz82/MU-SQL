...
public:
	...
	int MLS_SkillStrengthenMagicPower(OBJECTSTRUCT *lpObj, CMagicInf *lpMagic, int aTargetIndex);
	...
	void SkillIronDefenseDK(OBJECTSTRUCT *lpObj, int aTargetIndex, CMagicInf *lpMagic);
	void SkillIronDefenseDL(OBJECTSTRUCT *lpObj, int aTargetIndex, CMagicInf *lpMagic);
	...
	void SkillCircleShieldGrowLancer(int aIndex, CMagicInf * lpMagic, int aTargetIndex);
