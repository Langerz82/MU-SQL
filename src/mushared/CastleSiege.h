...
public:
	...
	void DecreaseLordMixLimit() { this->m_CurrentLordMixLimit--; }
	...
	BOOL m_bCastleSiegeFriendlyFire;
	BOOL m_TowerEntryWithoutAlliance;

	int CastleSiegeDmgReductionPercent;
	int CastleSiegeSelfDmgReductionPercent;
	int CastleSiegeResetAccumulationAfterKill;
	int CastleSiegeIsAccumulationTime;

	SYSTEMTIME m_tmLordMixTime;
	int m_CastleLordMixDailyLimit;
