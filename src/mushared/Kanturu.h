...
public:
	...
	int GetMoonStoneDropRate() { return this->m_iKanturuMoonStoneDropRate; }
	int GetJewelOfHarmonyDropRate() { return this->m_iKanturuJewelOfHarmonyDropRate; }
...
private:
	...
	int m_iKanturuMoonStoneDropRate;
	int m_iKanturuJewelOfHarmonyDropRate;
