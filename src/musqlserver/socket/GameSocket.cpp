...
void GameSocket::OnRead()
{
    const static AuthHandler table[] =
    {
        { CMD_AUTH_LOGON_CHALLENGE,     STATUS_CHALLENGE,   &GameSocket::_HandleLogonChallenge    },
        { CMD_AUTH_LOGON_PROOF,         STATUS_LOGON_PROOF, &GameSocket::_HandleLogonProof        },
        { CMD_AUTH_RECONNECT_CHALLENGE, STATUS_CHALLENGE,   &GameSocket::_HandleReconnectChallenge},
        { CMD_AUTH_RECONNECT_PROOF,     STATUS_RECON_PROOF, &GameSocket::_HandleReconnectProof    },
        { CMD_REALM_LIST,               STATUS_AUTHED,      &GameSocket::_HandleRealmList         },
        { CMD_XFER_ACCEPT,              STATUS_PATCH,       &GameSocket::_HandleXferAccept        },
        { CMD_XFER_RESUME,              STATUS_PATCH,       &GameSocket::_HandleXferResume        },
        { CMD_XFER_CANCEL,              STATUS_PATCH,       &GameSocket::_HandleXferCancel        }
    };
...
void GameSocket::_SetVSFields(const std::string& rI)
{
...
void GameSocket::SendProof(Sha1Hash sha)
{
    switch (_build)
    {
        case 5875:                                          // 1.12.1
...
bool GameSocket::_HandleLogonChallenge()
{
    ...
    // Memory will be freed on GameSocket object destruction
    _safelogin = _login;
...
bool GameSocket::_HandleLogonProof()
{
...
bool GameSocket::_HandleReconnectChallenge()
{
...
bool GameSocket::_HandleReconnectProof()
{
...
ACE_INET_Addr const& GameSocket::GetAddressForClient(Realm const& realm, ACE_INET_Addr const& clientAddr)
{
...
bool GameSocket::_HandleRealmList()
{
...
void GameSocket::LoadRealmlist(ByteBuffer& pkt, uint32 acctid)
{
...
bool GameSocket::_HandleXferResume()
{
...
bool GameSocket::_HandleXferCancel()
{
...
bool GameSocket::_HandleXferAccept()
{
