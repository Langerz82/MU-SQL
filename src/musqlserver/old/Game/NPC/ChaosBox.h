...
public:
	...
	int ChaosBoxMix(CGameObject &lpObj, int & Result2, int & WingNum);
	int  CheckDevilSquareItem(CGameObject &lpObj, int & eventitemcount, int & itemlevel);
	void LogDQChaosItem(CGameObject &lpObj);
	BOOL DevilSquareEventChaosMix(CGameObject &lpObj, BOOL bCheckType, int iItemLevel);
	void LogChaosItem(CGameObject &lpObj, LPSTR sLogType);
	BOOL PlusItemLevelChaosMix(CGameObject &lpObj, int mixType);
	void PlusItemLevelMixTest(CGameObject &lpObj, int type);
	void ChaosMixCharmItemUsed(CGameObject &lpObj);
	BOOL IsDeleteItem(int iItemCode);
	BOOL PegasiaChaosMix(CGameObject &lpObj);
	BOOL CircleChaosMix(CGameObject &lpObj);
	BOOL WingChaosMix(CGameObject &lpObj);
	BOOL IllusionTempleItemChaosMix(CGameObject &lpObj);
	...
	void SetItemChaosMix(CGameObject &lpObj);
	void DarkHorseChaosMix(CGameObject &lpObj);
	void DarkSpiritChaosMix(CGameObject &lpObj);
	void BlessPotionChaosMix(CGameObject &lpObj);
	void SoulPotionChaosMix(CGameObject &lpObj);
	void LifeStoneChaosMix(CGameObject &lpObj);
	void CastleSpecialItemMix(CGameObject &lpObj);
	void HiddenTreasureBoxItemMix(CGameObject &lpObj);
	void Fenrir_01Level_Mix(CGameObject &lpObj);
	void Fenrir_02Level_Mix(CGameObject &lpObj);
	void Fenrir_03Level_Mix(CGameObject &lpObj);
	void Fenrir_04Upgrade_Mix(CGameObject &lpObj);
	void ShieldPotionLv1_Mix(CGameObject &lpObj);
	void ShieldPotionLv2_Mix(CGameObject &lpObj);
	void ShieldPotionLv3_Mix(CGameObject &lpObj);
	void LotteryItemMix(CGameObject &lpObj, int type);
	BOOL SocketItemUpgradeMixS12(CGameObject &lpObj, BYTE ItemPos, BYTE SocketUpgradeNotePos, BYTE JoBlessPos1, BYTE JoBlessPos2, BYTE JoBlessPos3, BYTE JoBlessPos4, BYTE JoBlessPos5, BYTE JoSoulPos1, BYTE JoSoulPos2, BYTE JoSoulPos3, BYTE JoSoulPos4, BYTE JoSoulPos5, BYTE JoChaosPos);
	void SeedExtractMix(CGameObject &lpObj);
	BOOL SeedExtractMixS12(CGameObject &lpObj, BYTE AncientPos, BYTE ExePos, BYTE JOHPos, BYTE JOCPos, BYTE ChaosPos);
	void SeedSphereCompositeMix(CGameObject &lpObj);
	void SeedSphereCompositeMixS12(CGameObject &lpObj, BYTE SeedPos, BYTE SpherePos, BYTE JocPos, BYTE ChaosPos);
	BOOL SeedSphereEnhance(CGameObject &lpObj, BYTE Sphere1, BYTE Sphere2, BYTE Rune);
	void SetSeedSphereMix(CGameObject &lpObj, BYTE btPos);
	void SetSeedSphereMixS12(CGameObject &lpObj, BYTE ItemPos, BYTE Slot, BYTE SeedPos, BYTE JocPos, BYTE ChaosPos);
	void SeedSphereRemoveMix(CGameObject &lpObj, BYTE btPos);
	void SeedSphereRemoveMixS12(CGameObject &lpObj, BYTE ItemPos, BYTE Slot, BYTE JogPos, BYTE JohPos1, BYTE JohPos2, BYTE JohPos3, BYTE JohPos4, BYTE JohPos5, BYTE ChaosPos1, BYTE ChaosPos2, BYTE ChaosPos3, BYTE ChaosPos4, BYTE ChaosPos5);
	void SecromiconMix(CGameObject &lpObj);
	void PremiumBoxMix(CGameObject &lpObj);
	void CherryBlossomMix(CGameObject &lpObj);
	void ItemRefineMix(CGameObject &lpObj);
	void MonsterWingMix(CGameObject &lpObj);
	void SummonsMix(CGameObject &lpObj, int type);
	void CCFRewardMix(CGameObject &lpObj);
	void DSFRewardMix(CGameObject &lpObj);
	void AncientSoulItemMix(CGameObject &lpObj);
	void BloodAngelUnSealMix(CGameObject &lpObj, int iMixType);
	void BloodAngelUnSealMix2(CGameObject &lpObj, int iMixType);
	void DarkAngelMix(CGameObject &lpObj, int iMixType);
	void DarkAngelNextMix(CGameObject &lpObj, int iMixType);
	void DarkAngelWeaponMix(CGameObject &lpObj, int iMixType);
	void ArchangelHammerMix(CGameObject &lpObj);
	void BlessedAAMix(CGameObject &lpObj);
	BOOL AdvancedWingMix(CGameObject &lpObj);
	void BloodCastleMix(CGameObject &lpObj);
	BOOL CheckHeroSoulItem(int iItemCode);
	bool GetElementalTalismanOfLuckRate(CGameObject &lpObj, int* rate);
	bool GetTalismanOfLuckRate(CGameObject &lpObj, int* rate);
	// bloodangel mix
	BOOL bloodangelmix78(CGameObject &lpObj);
	BOOL bloodangelmix79(CGameObject &lpObj);
	BOOL bloodangelmix80(CGameObject &lpObj);
	BOOL bloodangelmix81(CGameObject &lpObj);

	BOOL bloodangelmix86(CGameObject &lpObj);
	BOOL bloodangelmix87(CGameObject &lpObj);
	BOOL bloodangelmix88(CGameObject &lpObj);
	BOOL bloodangelmix89(CGameObject &lpObj);

	BOOL bloodangelmix90(CGameObject &lpObj);
	BOOL bloodangelmix91(CGameObject &lpObj);
	BOOL bloodangelmix92(CGameObject &lpObj);
	BOOL bloodangelmix93(CGameObject &lpObj);

	BOOL bloodangelmix98(CGameObject &lpObj);
	BOOL bloodangelmix99(CGameObject &lpObj);
	BOOL bloodangelmix100(CGameObject &lpObj);
	BOOL bloodangelmix101(CGameObject &lpObj);

	BOOL bloodangelmix106(CGameObject &lpObj);
	BOOL bloodangelmix107(CGameObject &lpObj);
	BOOL bloodangelmix108(CGameObject &lpObj);
	BOOL bloodangelmix109(CGameObject &lpObj);

	BOOL bloodangelmix114(CGameObject &lpObj);
	BOOL bloodangelmix115(CGameObject &lpObj);
	BOOL bloodangelmix116(CGameObject &lpObj);
	BOOL bloodangelmix117(CGameObject &lpObj);

	BOOL bloodangelmix118(CGameObject &lpObj);
	BOOL bloodangelmix119(CGameObject &lpObj);
	BOOL bloodangelmix120(CGameObject &lpObj);
	BOOL bloodangelmix121(CGameObject &lpObj);

	BOOL bloodangelmix126(CGameObject &lpObj);
	BOOL bloodangelmix127(CGameObject &lpObj);
	...
	void CircleChaosMix_Multi(CGameObject &lpObj, int iMixCount);
	void PegasiaChaosMix_Multi(CGameObject &lpObj, int iMixCount);
	void BloodCastleItemChaosMix_Multi(CGameObject &lpObj, int iMixCount);
	void DevilSquareItemChaosMix_Multi(CGameObject &lpObj, int iMixCount);
	void ShieldPotionLv1_Mix_Multi(CGameObject &lpObj, int iMixCount);
	void ShieldPotionLv2_Mix_Multi(CGameObject &lpObj, int iMixCount);
