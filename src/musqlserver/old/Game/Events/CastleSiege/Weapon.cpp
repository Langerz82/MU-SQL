...
BOOL CWeapon::MissCheck(CGameObject &Obj, CGameObject lpTargetObj, int iSkill, int iSkillSuccess, BOOL& bAllMiss)
{
	return TRUE;
}
...
BOOL CWeapon::Attack(CGameObject &Obj, CGameObject lpTargetObj, CMagicInf * lpMagic, int iCriticalDamage, int iActionType)
{
	int iSkill = 0;
