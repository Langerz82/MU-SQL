...
public:
	...
	void SetMonster();
	void ClearMonstr();
	void gDevilSquareMonsterRegen(CGameObject &Obj);
	void DieProcDevilSquare(CGameObject &Obj);
	UINT64 gObjMonsterExpSingle(CGameObject &Obj, CGameObject lpTargetObj, int dmg, int tot_dmg);
	void gObjExpParty(CGameObject &Obj, CGameObject lpTargetObj, int AttackDamage, int MSBFlag);
	void gObjMonsterScoreDivision(CGameObject &MonObj, CGameObject lpObj, int AttackDamage, int MSBFlag);
