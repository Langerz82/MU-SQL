...
extern unsigned char GetPathPacketDirPos(int px, int py);
...
extern int gObjLevelUpPointAdd(unsigned char type, LPGameObject &lpObj, int aIndex);
...
extern unsigned char gObjInventoryInsertItem(LPGameObject &lpObj, int type, int index, int level, int iSerial, int iDur);
extern DWORD gGetItemNumber();
extern void gPlusItemNumber();
extern unsigned char gObjInventoryInsertItem(LPGameObject &lpObj, int type, int index, int level, int iSerial, int iDur);
extern unsigned char gObjOnlyInventoryInsertItem(LPGameObject &lpObj, class CItem item);
extern unsigned char gObjInventoryInsertItem(LPGameObject &lpObj, int type, int index, int level);
...
extern unsigned char gObjShopBuyInventoryInsertItem(LPGameObject &lpObj, class CItem item);
extern unsigned char gObjShopBuyMuunInventoryInsertItem(LPGameObject &lpObj, class CItem item);
extern unsigned char gObjShopBuyEventInventoryInsertItem(LPGameObject &lpObj, class CItem item);
extern unsigned char gObjInventoryInsertItemTemp(LPGameObject &lpObj, class CMapItem* Item);
extern unsigned char gObjInventoryInsertItem(LPGameObject &lpObj, class CMapItem* item);
extern unsigned char gObjInventoryInsertItem(LPGameObject &lpObj, class CItem item);
extern unsigned char gObjMonsterInventoryInsertItem(LPGameObject &lpObj, int type, int index, int level, int op1, int op2, int op3);
extern unsigned char gObjInventoryRectCheck(LPGameObject &lpObj, int sx, int sy, int width, int height);
extern unsigned char gObjOnlyInventoryRectCheck(LPGameObject &lpObj, int sx, int sy, int width, int height);
...
extern unsigned char gObjWerehouseRectCheck(LPGameObject &lpObj, int sx, int sy, int width, int height);
extern unsigned char gObjMapRectCheck(LPBYTE lpMapBuf, int sx, int sy, int ex, int ey, int width, int height);
...
extern unsigned char gObjChaosBoxInsertItemPos(LPGameObject &lpObj, class CItem item, int pos, int source);
extern unsigned char gObjWarehouseInsertItemPos(LPGameObject &lpObj, class CItem item, int pos, int source);
extern unsigned char gObjInventoryInsertItemPos(LPGameObject &lpObj, class CItem item, int pos, int RequestCheck);
...
extern unsigned char gObjInventoryMoveItem(LPGameObject &lpObj, BYTE source, BYTE target, int& durSsend, int& durTsend, BYTE sFlag, BYTE tFlag, LPBYTE siteminfo);
extern unsigned char gObjTradeRectCheck(LPGameObject &lpObj, int sx, int sy, int width, int height);
extern int gObjTradeItemBoxSet(LPGameObject &lpObj, int itempos, int xl, int yl, BYTE set_byte);
extern unsigned char gObjTradeInventoryMove(LPGameObject &lpObj, BYTE source, BYTE target);
extern unsigned char gObjInventoryTradeMove(LPGameObject &lpObj, BYTE source, BYTE target);
extern unsigned char gObjTradeTradeMove(LPGameObject &lpObj, BYTE source, BYTE target);
...
extern unsigned char gObjTempInventoryRectCheck(LPGameObject &lpObj, LPBYTE TempMap, int sx, int sy, int width, int height);
extern unsigned char gObjTempInventoryInsertItem(LPGameObject &lpObj, class CItem item, LPBYTE TempMap);
...
extern unsigned char LevelSmallConvert(int level);
extern unsigned char LevelSmallConvert(LPGameObject &lpObj, int inventoryindex);
...
extern void SkillFrustrum(unsigned char bangle, int aIndex);
...
extern unsigned char gObjPentagramMixBoxInsertItemPos(LPGameObject &lpObj, CItem item, int pos, int source);
extern unsigned char gObjPentagramMixBoxInsertItem(LPGameObject &lpObj, CItem item);
extern unsigned char gObjPentagramMixBoxRectCheck(LPGameObject &lpObj, int sx, int sy, int width, int height);
extern unsigned char gObjPentagramMixBoxDeleteItem(LPGameObject &lpObj, int itempos);
