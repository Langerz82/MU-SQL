...
extern BYTE gObjEventInventoryInsertItem(CGameObject &lpObj, CItem item);
...
extern BYTE gObjTempEventInventoryInsertItem(CGameObject &lpObj, CItem item, BYTE * TempMap);
...
extern BYTE gObjEventInventoryInsertItemPos(CGameObject &lpObj, CItem item, int pos, BOOL RequestCheck);
