...
public:
	...
	friend CObjAttack;
	friend void gObjCharZeroSet(CGameObject &lpObj);
	...
	BYTE ResetMasterSkill(CGameObject &lpObj, int nTreeType);
	BYTE CheckMasterSkillPoint(CGameObject &lpObj, int nTreeType);
	...
	void MLS_SkillStrengthenExPoison(CGameObject &lpObj, CMagicInf *lpMagic, BYTE x, BYTE y, int aTargetIndex);
	...
	void MLS_SkillInfinityArrow(CGameObject &lpObj, int aTargetIndex, CMagicInf *lpMagic);
	void MLS_SkillStrengthenBerserker(CGameObject &lpObj, CMagicInf *lpMagic);
	void MLS_SkillSkillfulBerserker(CGameObject &lpObj, CMagicInf *lpMagic);
	void MLS_SkillMasteryBerserker(CGameObject &lpObj, CMagicInf *lpMagic);
	void MLS_SkillStrengthenBlast(CGameObject lpObj, CMagicInf *lpMagic, int aTargetIndex);
	void MLS_SkillStrendthenAddCriticalDamage(CGameObject &lpObj, CMagicInf *lpMagic);
	void MLS_SkillSkillFulAddCriticalDamage(CGameObject &lpObj, CMagicInf *lpMagic);
	void MLS_SkillMasteryAddCriticalDamage(CGameObject &lpObj, CMagicInf *lpMagic);
	...
	void MLS_SkillStrengthenSpear(CGameObject &lpObj, int aTargetIndex, CMagicInf *lpMagic);
	void MLS_SkillAreaMonsterAttack(CGameObject &lpObj, CMagicInf *lpMagic, BYTE x, BYTE y, int aTargetIndex, int aDistance, BOOL bPVP, int nSuccessRate, int nDelay);
	void MLS_SuddenIce(CGameObject &lpObj, CMagicInf *lpMagic, BYTE x, BYTE y, int aTargetIndex);
	int MLS_CalDistance(int x, int y, int x1, int y1);
	int MLS_GetAngle(int x, int y, int tx, int ty);
	void MLS_SkillFrustrum(CGameObject &lpObj, float fangle, float tx, float ty);
	void MLS_KnightBlow(CGameObject &lpObj, int aTargetIndex, CMagicInf *lpMagic, BOOL isCombo);
	void MLS_SkillBlowOfFury(CGameObject &lpObj, CMagicInf *lpMagic, BYTE x, BYTE y, int aTargetIndex, BOOL isCombo);
	void MLS_SkillDefense(CGameObject &lpObj, int aTargetIndex, CMagicInf *lpMagic);
	void MLS_SkillAttack(CGameObject &lpObj, int aTargetIndex, CMagicInf *lpMagic);
	void MLS_SkillStrengthenDefense(CGameObject &lpObj, int aTargetIndex, CMagicInf *lpMagic);
	void MLS_SkillStrenghtenAttack(CGameObject &lpObj, int aTargetIndex, CMagicInf *lpMagic);
	void MLS_MaGumSkillDefenseDown(CGameObject &lpObj, int aTargetIndex);
	void MLS_PowerSlash(CGameObject &lpObj, CMagicInf *lpMagic, BYTE x, BYTE y, BYTE Targetangle, int aTargetIndex);
	void MLS_FireScream(CGameObject &lpObj, int aTargetIndex, CMagicInf *lpMagic);
	void MLS_SkillMonkBarrageJustOneTarget(CGameObject &lpObj, CMagicInf *lpMagic, int aTargetIndex);
	void MLS_SkillStrengthenDragonRoar(CGameObject &lpObj, CMagicInf *lpMagic, BYTE x, BYTE y, int aTargetIndex, int aDistance, BOOL bPVP, int nDelay);
	void MLS_SkillStrengthenBlockRate(CGameObject &lpObj, CMagicInf *lpMagic);
	void MLS_SkillMasteryBlockRate(CGameObject &lpObj, CMagicInf *lpMagic);
	void MLS_SkillStrengthenIncVital(CGameObject &lpObj, CMagicInf *lpMagic);
	void MLS_SkillStrengthenIgnoreEnemyDefense(CGameObject &lpObj, CMagicInf *lpMagic);
	...
	void MLS_SkillMonsterCall(CGameObject &lpObj, int MonsterType, int x, int y);
	void MLS_SkillPartyHealing(CGameObject &lpObj, int aTargetIndex, CMagicInf *lpMagic);
	...
	void MLS_SkillfulKnightBlow(CGameObject &lpObj, int aTargetIndex, CMagicInf *lpMagic, BOOL isCombo);
	void MLS_MasteryKnightBlow(CGameObject &lpObj, int aTargetIndex, CMagicInf *lpMagic, BOOL isCombo);
	...
	void MLS_MasterySuddenIce(CGameObject &lpObj, CMagicInf *lpMagic, BYTE x, BYTE y, int aTargetIndex);
	void MLS_SkillStrengthenMultiShot(CGameObject &lpObj, CMagicInf *lpMagic, BYTE bAngle, int aTargetIndex);
	void MLS_SkillHellBust(CGameObject &lpObj, int aTargetIndex, CMagicInf *lpMagic);
	void MLS_SkillHellBustStart(CGameObject &lpObj, CMagicInf *lpMagic);
	void MLS_SkillMasteryWizardMagicDefense(CGameObject lpObj, CMagicInf *lpMagic, int aTargetIndex);
	void MLS_SkillStrengthenWeakness(CGameObject &lpObj, CMagicInf *lpMagic, BYTE x, BYTE y, int aTargetIndex);
	void MLS_SkillStrengthenEnervation(CGameObject &lpObj, CMagicInf *lpMagic, BYTE x, BYTE y, int aTargetIndex);
	void MLS_SkillMasteryIce(CGameObject lpObj, CMagicInf *lpMagic, int aTargetIndex);
	void MLS_SkillStrengthenFlameStrike(CGameObject &lpObj, CMagicInf *lpMagic, BYTE bAngle, int aTargetIndex);
	void MLS_SkillGiganticStorm(CGameObject &lpObj, CMagicInf *lpMagic, BYTE x, BYTE y, int aTargetIndex);
	void MLS_SkillMasteryDefenseDown(CGameObject &lpObj, int aTargetIndex, CMagicInf *lpMagic);
	void MLS_SkillMasteryAddCriticalDamage2(CGameObject &lpObj, CMagicInf *lpMagic);
	void MLS_SkillFrustrum3(CGameObject &lpObj, BYTE bAngle, float tx1, float ty1, float tx2, float ty2);
	void MLS_SkillStrengthenElectricSpark(CGameObject &lpObj, CMagicInf *lpMagic, BYTE x, BYTE y, BYTE TargetPos, int aTargetIndex);
	void MLS_SkillStrengthenchaoticDesair(CGameObject &lpObj, CMagicInf *lpMagic, BYTE bAngle, int aTargetIndex);
	...
	void MLS_SkillSleep(CGameObject &lpObj, int aTargetIndex, CMagicInf *lpMagic);
	void MLS_SkillChainLightning(CGameObject &lpObj, int aTargetIndex, CMagicInf *lpMagic);
	void MLS_SkillLightningShock(CGameObject &lpObj, int aTargetIndex, CMagicInf *lpMagic);
	void MLS_SkillDrainLife(CGameObject &lpObj, int aTargetIndex, CMagicInf *lpMagic);
	void SkillCircleShieldGrowLancer(CGameObject &lpObj, CMagicInf * lpMagic, int aTargetIndex);
	int SkillWrathPowUpGrowLancer(CGameObject &lpObj, CMagicInf * lpMagic, int aTargetIndex);
	int SkillWrathProficiencyGrowLancer(CGameObject &lpObj, CMagicInf * lpMagic, int aTargetIndex);
	int SkillWrathMasteryGrowLancer(CGameObject &lpObj, CMagicInf * lpMagic, int aTargetIndex);
	int SkillObsidianPowUpGrowLancer(CGameObject &lpObj, CMagicInf * lpMagic, int aTargetIndex);
	void SkillBurstMasteryGrowLancer(CGameObject &lpObj, CMagicInf * lpMagic, int aTargetIndex);
	// FINISHED
