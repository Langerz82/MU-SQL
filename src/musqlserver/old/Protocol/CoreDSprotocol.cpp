...
void CDataServerProtocol::ProtocolCore(int aIndex, BYTE HeadCode, LPBYTE aRecv, int iSize)
{
	...
	case 0xE5:
		...
		break;
	case 0xE6:
		m_DSProtocol.GDReqLoadEventInvenItem(aIndex, (SDHP_REQ_DBEVENT_INVEN_LOAD *)aRecv);
		break;
	case 0xE7:
		m_DSProtocol.GDReqSaveEventInvenItem(aIndex, (SDHP_REQ_DBEVENT_INVEN_SAVE *)aRecv);
		break;
	case 0xE8:
	{
		PMSG_DEFAULT2 * lpMsg = reinterpret_cast<PMSG_DEFAULT2 *>(aRecv);
		...
		case 0x06:
			...
			break;
		case 0x07:
			m_DSProtocol.GDReqMuRummyDBLog(aIndex, (PMSG_REQ_MURUMMY_LOG_INSERT_DS *)aRecv);
			break;
		}
	}
	break;
	...
	case 0xF1:
		...
		break;
	case 0xF2:
		m_DSProtocol.GDReqSaveMuunInvenItem(aIndex, (SDHP_REQ_DBMUUN_INVEN_SAVE*)aRecv);
		break;
	case 0xF3:
	{
		PMSG_DEFAULT2 * lpMsg = reinterpret_cast<PMSG_DEFAULT2 *>(aRecv);
