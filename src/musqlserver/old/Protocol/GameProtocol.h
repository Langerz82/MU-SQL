...
public:
	...
	void GCItemObjectInventoryPutSend(CGameObject &lpObj, BYTE result, BYTE iteminfo1, BYTE iteminfo2);
	...
	void GCItemObjectMoveResultSend(CGameObject &lpObj, BYTE result, BYTE pos, BYTE* const ItemInfo);
	...
	void GCItemObjectUseSpecialTimeSend(CGameObject &lpObj, BYTE number, int time);
	void GCItemObjectDurSend(CGameObject &lpObj, BYTE pos, BYTE dur, BYTE flag);
	void GCItemObjectDurSend2(CGameObject &lpObj, BYTE pos, BYTE dur, BYTE flag);
