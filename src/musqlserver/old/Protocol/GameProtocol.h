...
public:
	...
	void ItemDurRepaire(CGameObject* lpObj, /*int aIndex, */class CItem* DurItem, int pos, int RequestPos);
	...
	void GCActionSend(CGameObject* lpObj, BYTE ActionNumber, int aIndex, int aTargetIndex);
