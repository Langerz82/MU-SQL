...
public:
	...
	void CGLiveClient(PMSG_CLIENTTIME* lpClientTime, CGameObject &Obj);
	...
	void PEchoProc(BYTE* aMsg, int aLen, CGameObject &Obj);
	...
	void PChatProc(PMSG_CHATDATA* lpChat, CGameObject &Obj);
...
extern void ItemCreate(CGameObject &Obj, BYTE MapNumber, BYTE x, BYTE y, int type, BYTE level, BYTE dur, BYTE Op1, BYTE Op2, BYTE Op3, int LootIndex, BYTE NewOption, BYTE SetOption);
extern void ItemCreate(CGameObject &Obj, BYTE MapNumber, BYTE x, BYTE y, int type, BYTE level, BYTE dur, BYTE Op1, BYTE Op2, BYTE Op3, int LootIndex, BYTE NewOption, BYTE SetOption, time_t ExpTime);
