...
void CConfigread::ReadOffTradeConfig()
{
	...
	pugi::xml_node mainXML = file.child("OffTrade");

	this->offtrade.enabled = mainXML.attribute("Enable").as_int();
	this->offtrade.CoinType = mainXML.attribute("CoinType").as_int();
...
void CConfigread::ReadPKSettings()
{
	...
	pugi::xml_node mainXML = file.child("PlayerKillSystem");

	this->pk.iPKPointDeductionDivisor = mainXML.attribute("PointDeductionDivisor").as_int();
	this->pk.iPKPointIncForMurderer = mainXML.attribute("MurdererPointIncrease").as_int();
	this->pk.bPkLevelIncreaseOff = mainXML.attribute("DisablePKLevelIncrease").as_bool();
	this->pk.bPkPenaltyDisable = mainXML.attribute("DisablePenalty").as_bool();
	this->pk.bPkCanUseShops = mainXML.attribute("PKCanUseshops").as_bool();
	this->pk.bPkDropExpensiveItems = mainXML.attribute("DropExpensiveItems").as_bool();
	this->pk.iPkMaxLevelItemDrop = mainXML.attribute("MaxItemLevelDrop").as_int();
	pugi::xml_node pk_clear = mainXML.child("PKClearCommand");
	...
	pugi::xml_node exp_dec = mainXML.child("ExpDeduction");
