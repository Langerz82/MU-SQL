...
#ifndef MUSQL_DEFINE_H
#define MUSQL_DEFINE_H
...
#    define MUSQL_ENDIAN MUSQL_LITTLEENDIAN
 ...
 *
 */
typedef ACE_SHLIB_HANDLE MUSQL_LIBRARY_HANDLE;

#define MUSQL_SCRIPT_NAME "mangosscript"
#define MUSQL_SCRIPT_SUFFIX ACE_DLL_SUFFIX
#define MUSQL_SCRIPT_PREFIX ACE_DLL_PREFIX
#define MUSQL_LOAD_LIBRARY(libname)    ACE_OS::dlopen(libname)
#define MUSQL_CLOSE_LIBRARY(hlib)      ACE_OS::dlclose(hlib)
#define MUSQL_GET_PROC_ADDR(hlib,name) ACE_OS::dlsym(hlib,name)

#define MUSQL_PATH_MAX PATH_MAX                            // ace/os_include/os_limits.h -> ace/Basic_Types.h

#if PLATFORM == PLATFORM_WINDOWS
#  define MUSQL_EXPORT __declspec(dllexport)
#  define MUSQL_IMPORT __cdecl
#else // PLATFORM != PLATFORM_WINDOWS
#  define MUSQL_EXPORT export
#  if defined(__APPLE_CC__) && defined(BIG_ENDIAN)
#    if (defined(__ppc__) || defined(__powerpc__))
#      define MUSQL_IMPORT __attribute__ ((longcall))
#    else
#      define MUSQL_IMPORT
#    endif
...
#    define MUSQL_IMPORT
#  else
#    define MUSQL_IMPORT __attribute__ ((cdecl))
#  endif //__APPLE_CC__ && BIG_ENDIAN
#endif // PLATFORM

#if PLATFORM == PLATFORM_WINDOWS
#  define MUSQL_DLL_SPEC __declspec(dllexport)
#  ifndef DECLSPEC_NORETURN
#    define DECLSPEC_NORETURN __declspec(noreturn)
#  endif // DECLSPEC_NORETURN
#else // PLATFORM != PLATFORM_WINDOWS
#  define MUSQL_DLL_SPEC
#  define DECLSPEC_NORETURN
#endif // PLATFORM

#if !defined(DEBUG)
#  define MUSQL_INLINE inline
#else // DEBUG
#  if !defined(MUSQL_DEBUG)
#    define MUSQL_DEBUG
#  endif // MUSQL_DEBUG
#  define MUSQL_INLINE
#endif //!DEBUG
